...
execute at @s \
if block ~-2 ~ ~-1 #minecraft:replaceable \
if block ~-2 ~ ~ #minecraft:replaceable \
if block ~-2 ~ ~1 #minecraft:replaceable \
if block ~-1 ~ ~-2 #minecraft:replaceable \
if block ~-1 ~ ~-1 #minecraft:replaceable \
...
title @p actionbar {"text":"Failed to create a portal - the creation area is obstructed","color":"red"}
