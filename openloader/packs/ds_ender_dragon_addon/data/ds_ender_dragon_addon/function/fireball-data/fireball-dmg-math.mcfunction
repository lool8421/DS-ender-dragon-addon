...
#cloud duration
$scoreboard players set temp dseda_var $(level)
scoreboard players add temp dseda_var 5
...
$scoreboard players set temp2 dseda_var $(multiplier)
scoreboard players operation temp dseda_var *= temp2 dseda_var
execute store result storage minecraft:dseda_fireball_explosion clouddmg double 0.004 run scoreboard players get temp dseda_var
...
$scoreboard players set temp dseda_var $(level)
scoreboard players add temp dseda_var 5
execute store result storage minecraft:dseda_fireball_explosion clouddensity int 4 run scoreboard players get temp dseda_var
