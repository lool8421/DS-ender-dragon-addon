...
$summon marker ~ ~-1 ~ {Tags:['dseda_damage_cloud','dseda_lifespan'],data:{owner:$(OwnerUUID),damage:$(clouddmg),radius:$(cloudradius),duration:$(cloudduration),density:$(clouddensity),particleradius:$(particleradius)}}
