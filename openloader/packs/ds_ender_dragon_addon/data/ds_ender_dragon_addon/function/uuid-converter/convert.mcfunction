...
$data modify storage dseda_uuid_converter:main in set value $(UUID)

execute store result score 0= dseda_uuid_converter.main store result score 1= dseda_uuid_converter.main run data get storage dseda_uuid_converter:main in[0]
...
execute store result score 0= dseda_uuid_converter.main store result score 1= dseda_uuid_converter.main run data get storage dseda_uuid_converter:main in[1]
...
execute store result score 0= dseda_uuid_converter.main store result score 1= dseda_uuid_converter.main run data get storage dseda_uuid_converter:main in[2]
...
execute store result score 0= dseda_uuid_converter.main store result score 1= dseda_uuid_converter.main run data get storage dseda_uuid_converter:main in[3]
